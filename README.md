...
<br>
All movie related information is fetched from a third party API - [themoviedb.org](themoviedb.org).
<br>
<br>
The project can be viewed [here](https://movie-db-reactjs.herokuapp.com/).
